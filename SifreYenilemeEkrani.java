...
public class SifreYenilemeEkrani extends javax.swing.JFrame implements IDuzenleyici,IBilgiController {
    ...
    private void initComponents() {
        ...
        setTitle("Banka Şifre Yenileme Ekranı");

        sifreYenilemePanel.setBackground(new java.awt.Color(204, 204, 255));
        ...
        sifreyiYenileButton.setBackground(new java.awt.Color(255, 204, 204));
        ...
        sifreYenilemePanelLayout.setVerticalGroup(
            ...
            .addGroup(sifreYenilemePanelLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(sifreyiYenileButton, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void sifreyiYenileButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_sifreyiYenileButtonMouseEntered
        ButtonAyarlari.setBgFg(sifreyiYenileButton, Color.pink, Color.magenta);
